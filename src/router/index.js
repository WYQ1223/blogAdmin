...

  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '添加文章', icon: 'form', auth: true }
      },
      {
        path: '/blog/blogModify/:id',
        name: 'BlogModify',
        component: () => import('@/views/blog/blogModify'),
        meta: { title: '编辑文章', icon: 'form', auth: true },
        hidden: true
      }
    ]
  },
